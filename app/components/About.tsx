...
export default function About() {
  ...
  return (
    <div ref={aboutRef} className="h-[200vh] w-full">
      ...
      >
        <div className="mx-auto w-full max-w-[min(520px,94vw)] md:max-w-6xl bg-white rounded-[inherit] p-5 sm:p-6 md:p-10 lg:p-12">
          <motion.div
            style={{ scale: contentScale }}
            className="grid grid-cols-1 items-center gap-8 sm:gap-10 md:grid-cols-2 md:gap-12"
          >
            {/* Left: Copy */}
            <div className="order-2 flex flex-col gap-y-5 sm:gap-y-6 md:order-1 lg:gap-y-8 px-5 sm:px-6 md:px-0">
            ...
            <div className="order-1 flex w-full items-center justify-center md:order-2">
              <div className="relative w-full h-[clamp(220px,38vh,360px)] max-w-[min(440px,88vw)] overflow-hidden rounded-3xl">
                <Image
                  src="/about.png"
                  alt="About ViFi"
                  fill
